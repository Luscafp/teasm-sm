    ...
    <SafeAreaView className="bg-background flex-1 pt-4">
      ...
      <View className="flex-1 justify-center mt-8 gap-y-4 px-6">
        <View className="gap-y-4">
          ...
          <AppButton onPress={() => handleNavigate('vitamina a/vitaminaa')}>
            <Text className="text-primary text-xl font-bold text-center">Vitamina A</Text>
          </AppButton>

          <AppButton onPress={() => handleNavigate('vitamina d/vitaminad')}>
            <Text className="text-primary text-xl font-bold text-center">Vitamina D</Text>
          </AppButton>
        </View>
      </View>
